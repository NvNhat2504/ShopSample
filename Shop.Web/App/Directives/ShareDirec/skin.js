    ...
    .directive('skinChanger', ['$rootScope', '$filter','$state', '$stateParams', function ($rootScope, $filter, $state, $stateParams) {
        return {
            ...
            link: function (scope, el, attr) {
                ...
                scope.skins = [
                    {
                        skin: '../../Assets/Admin/css/skins/blue.min.css',
                        color: {
                            themeprimary: '#5db2ff',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/azure.min.css',
                        color: {
                            themeprimary: '#2dc3e8',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/black.min.css',
                        color: {
                            themeprimary: '#474544',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/darkblue.min.css',
                        color: {
                            themeprimary: '#0072c6',
                            themesecondary: '#fb6e52',
                            themethirdcolor: '#ffce55',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/darkred.min.css',
                        color: {
                            themeprimary: '#ac193d',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/deepblue.min.css',
                        color: {
                            themeprimary: '#001940',
                            themesecondary: '#d73d32',
                            themethirdcolor: '#ffce55',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/gray.min.css',
                        color: {
                            themeprimary: '#585858',
                            themesecondary: '#fb6e52',
                            themethirdcolor: '#ffce55',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/green.min.css',
                        color: {
                            themeprimary: '#53a93f',
                            themesecondary: '#ed4e2a',
                            themethirdcolor: '#ffce55',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/orange.min.css',
                        color: {
                            themeprimary: '#ff8f32',
                            themesecondary: '#7bd148',
                            themethirdcolor: '#5db2ff',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/pink.min.css',
                        color: {
                            themeprimary: '#cc324b',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/purple.min.css',
                        color: {
                            themeprimary: '#8c0095',
                    ...
                    {
                        skin: '../../Assets/Admin/css/skins/teal.min.css',
                        color: {
                            themeprimary: '#03b3b2',
                            themesecondary: '#ed4e2a',
                            themethirdcolor: '#ffce55',
